...
import (
	...
	reader "async_course/analytics/internal/event_reader"
	writer "async_course/analytics/internal/event_writer"
	httpAPI "async_course/analytics/internal/http_api"
...
func main() {
	...
	// set schema registry
	sr := schema.NewSchemaRegistry(analytics.ProducerName)
	...
	er.StartReaders(brokers, analytics.KafkaConsumerGroupID)
	...
	api.Use(echojwt.WithConfig(echojwt.Config{
		NewClaimsFunc: func(c echo.Context) jwt.Claims {
			return new(analytics.JwtCustomClaims)
		},
